					...
					<div class="navbar-header nav_2">
						<button type="button" class="navbar-toggle collapsed navbar-toggle1" data-toggle="collapse" data-target="#bs-megadropdown-tabs">
						 ...
						 <div class="navbar-brand logo-nav-left wow fadeInLeft animated" data-wow-delay=".5s">
							<h1 class="animated wow pulse" data-wow-delay=".5s"><a href="index.html">5M<span>INTERNATIONAL</span></a></h1>
						</div>
...
<fieldset id="co1"> 
  ...
  <legend> votre information personelle : salut Mr/M <?PHP echo ''.$_SESSION['l'];?>  </legend>
<div class="row wow fadeInRight animated" data-wow-delay=".5s">
        <div class="col-sm-4">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">votre nom</h3>
            </div>
          ...
          <div class="panel panel-primary">
            <div class="panel-heading">
              <h3 class="panel-title">votre prenom</h3>
            </div>
            <div class="panel-body">
        ...
        <div class="col-sm-4">
          <div class="panel panel-success">
            <div class="panel-heading">
              <h3 class="panel-title">votre date de naissance</h3>
            </div>
            <div class="panel-body">
              <?PHP echo ''.$_SESSION['d'];?>
            </div>
          ...
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title">votre mail </h3>
            </div>
            <div class="panel-body">
               <?PHP echo ''.$_SESSION['e'];?>
            </div>
          ...
          <div class="panel panel-warning">
            <div class="panel-heading">
              <h3 class="panel-title">votre sexe</h3>
            </div>
            <div class="panel-body">
              <?PHP echo ''.$_SESSION['s'];?>
            </div>
          ...
          <div class="panel panel-danger">
            <div class="panel-heading">
              <h3 class="panel-title">votre adresse</h3>
            </div>
            <div class="panel-body">
...
<ul class="footer_links clearfix">
	<li><a class="btn btn-default" href="espaceclient.php"> modifier votre compte</a></li>
</ul>
